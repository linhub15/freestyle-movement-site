      ...
      >
        ...
        <div className="space-y-12">
          <div className="space-y-6">
            ...
            <DescriptionList>
              <Description
                Icon={<KeyValueIcon label="2026" value="Tue" />}
                term="Tuesdays"
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-8">
            <ContentCard
              ...
              title="2026 Jan to Apr Schedule (Tuesdays)"
            >
              <ul>
                <li>Jan 6, 13, 20, 27</li>
                <li>Feb 3, 10, 17, 24</li>
                <li>Mar 3, 10, 17, 31</li>
                <li>Apr 7, 14, 21, 28</li>
              </ul>

              <div className="pt-8 pb-4">
                <ETransferInfo amount="$272" />
              </div>
            </ContentCard>
