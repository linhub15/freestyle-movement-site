export default function ({ socials }) {
  const array = [
    { title: "Instagram", link: socials.instagram, icon: <InstagramIcon /> },
    { title: "Facebook", link: socials.facebook, icon: <FacebookIcon /> },
    { title: "Youtube", link: socials.youtube, icon: <YoutubeIcon /> },
  ];
  return (
    <>
      {array.map((item, idx) => (
